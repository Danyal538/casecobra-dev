...
const OrderReceivedEmail = ({ shippingAddress, orderId, orderDate }: { shippingAddress: ShippingAddress, orderId: string, orderDate: string }) => {
    const baseUrl = process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://casecobra-dev-phi.vercel.app"
    return (
        <Html>
            <Head />
            <Preview>
                Your order summary and an estimated delivery date
            </Preview>
            <Body style={main}>
